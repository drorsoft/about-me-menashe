function Home() {
  return (
    <>
      <section className="mb-8 p-6 bg-[--color-cartoon-blue] text-white rounded-lg border-4 border-black">
        ...
        <img src="https://images.unsplash.com/photo-1558679908-541bcf1249ff?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHN1cGVybWFufGVufDB8fDB8fHww&fm=jpg&q=60&w=3000" alt="Superman" className="mx-auto my-4 rounded-lg border-4 border-black" />
      </section>

      <section className="p-6 bg-[--color-cartoon-pink] text-white rounded-lg border-4 border-black">
