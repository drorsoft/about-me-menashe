function ContactInfo() {
  return (
    <div className="p-6 bg-[--color-cartoon-blue] text-white rounded-lg border-4 border-black">
      <h1 className="text-4xl font-bold mb-8 text-center text-[--color-cartoon-red]">Contact Info</h1>
      <p className="mb-4 text-xl">I am a passionate professional with expertise in modern web development and a strong focus on creating user-friendly applications.</p>
